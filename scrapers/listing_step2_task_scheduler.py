...
def create_windows_task(task_name, command, scheduled_time, task_type="once", expire_time=None):
    ...
    try:
        ...
        target_script_path = os.path.join(script_dir, "listing_step2_scrape_one_url.py")
...
def main():
    ...
    try:
        ...
        script_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "listing_step2_scrape_one_url.py")
